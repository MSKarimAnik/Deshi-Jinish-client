...
const Header = () => {
    ...
    return (
        ...
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-4xl font-extrabold text-orange-600">DESHI JINISH</a>
        </div>
        ...
        <div className="navbar-end "> 
            <a className="btn mr-5 bg-green-500">Log In</a>
            <a className="btn bg-blue-400">Register</a>
        </div>
